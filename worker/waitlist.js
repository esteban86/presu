...
function followupHtml(r) {
  ...
  <div style="max-width:540px;margin:0 auto;padding:20px 24px 36px">
    ...
    <p class="t-body" style="font-size:16px;line-height:1.55;color:#C9C9CE;margin:0 0 18px">${hola} La beta ya está abierta. Descárgala para <b class="t-white" style="color:#fff">Mac o Windows</b> —se instala en un minuto y tus datos viven <b class="t-white" style="color:#fff">en tu equipo</b> (local-first: ni nosotros podemos leerlos).</p>
    <div style="background:#0E2A20;border:1px solid rgba(52,211,153,.5);border-radius:16px;padding:16px 20px;margin:0 0 26px">
      <p class="t-body" style="font-size:16px;line-height:1.5;color:#D4D4D6;margin:0">🎁 Como pionero tienes <b class="t-mint" style="color:#34D399">Presu Pro gratis por 3 meses</b> —sin tarjeta, sin nada. Tu tiempo gratis <b class="t-white" style="color:#fff">arranca cuando la abras por primera vez</b>.</p>
    </div>
